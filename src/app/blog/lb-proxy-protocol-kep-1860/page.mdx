...
| Bật Proxy Protocol theo doc GreenNode.ai | External traffic OK, nhưng pod nội bộ fail |
| Debug với GreenNode.ai support | tcpdump xác nhận traffic không ra khỏi node, iptables rules là thủ phạm |
