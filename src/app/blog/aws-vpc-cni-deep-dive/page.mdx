...
<div style={{display: 'flex', justifyContent: 'center', margin: '2rem 0'}}>
  <img
    ...
    alt="EKS Node Network Namespaces - veth pairs kết nối Pod namespaces với host"
...
<div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '2rem', margin: '2rem 0', flexWrap: 'wrap'}}>
  <img
    ...
    alt="Legacy model - mỗi network cần một vNIC riêng"
    style={{maxWidth: '400px', height: 'auto'}}
  />
  <img
    src="/images/aws-vpc-cni-deep-dive/trunk-vnics-after.png"
    alt="Trunk model - một vNIC với VLAN encapsulation"
    style={{maxWidth: '400px', height: 'auto'}}
  />
</div>
...
- [Tổng quan Kubernetes CNI](/blog/kubernetes-cni-overview) - So sánh các CNI approach: GKE, EKS, Cilium, Calico
